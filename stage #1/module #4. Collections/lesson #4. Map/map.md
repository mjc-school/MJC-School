Map<K,V> Interface (_java.util.Map_)
=================================================
## Materials
* Overview
* HashMap
...
## Overview
The **Map** interface present in _java.util_ package represents a mapping between a key and a value. The **Map** interface _**is not a subtype**_ of the **Collection** interface. Therefore it behaves a bit differently from the rest of the collection types. A **Map** contains unique keys.
