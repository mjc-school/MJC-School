...
The recommended timeline for the whole lambda part is approximately 6 hours.
...
- A Lambda function has layers. A layer is a ZIP archive that contains libraries, a custom runtime, or other dependencies.   <br /> [read more](https://docs.aws.amazon.com/lambda/latest/dg/configuration-layers.html) 
...
- c) Aliases
- d) Handlers
7. How is the cost associated with Lambda function calculated?
