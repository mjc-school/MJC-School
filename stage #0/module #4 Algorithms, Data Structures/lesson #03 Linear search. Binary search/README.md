...
Linear search is also called as **sequential search algorithm**. It is the simplest searching algorithm. In Linear search, we simply traverse the list completely and match each element of the list with the item whose location is to be found. If the match is found, then the **index**(position) of the item is returned, otherwise, the algorithm returns usually a non-existent index **-1**.
...
1. [Linear Search Algorithm](https://www.javatpoint.com/linear-search)
2. [Binary Search Algorithm](https://www.geeksforgeeks.org/binary-search/)